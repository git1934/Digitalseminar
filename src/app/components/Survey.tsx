      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-2xl text-gray-600">
            本日のプレゼンテーションをより有意義なものにするため、簡単なアンケートへのご協力をお願いいたします
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-8 shadow-lg border border-gray-100">
              ...
              <ol className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1">スマートフォンを準備</h4>
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1">QRコードを読み取り</h4>
                    <p className="text-lg text-gray-600">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1">アンケートに回答</h4>
                    <p className="text-lg text-gray-600">
            ...
            <div className="bg-gradient-to-r from-black to-gray-800 rounded-xl p-6 text-white">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-xl mb-3">アンケート内容</h4>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl border-4 border-[#FCCE00]">
              ...
              <div className="mt-5 text-center">
                <div className="flex items-center justify-center gap-3 text-[#FCCE00] mb-2">
                  ...
                  <span className="font-bold text-xl">こちらからアクセス</span>
                </div>
