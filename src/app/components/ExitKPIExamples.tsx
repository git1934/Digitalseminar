import { CalendarX, Coins, UsersRound, Check, ChevronRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="px-16 pt-10 pb-6">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-5 h-0.5 bg-[#FCCE00]"></div>
            <span className="text-sm font-bold text-[#FCCE00] uppercase tracking-wider">
              KPI STRATEGY
            </span>
          </div>
        ...
        {/* Main Content */}
        <div className="px-16 py-8 flex gap-10 relative">
          {/* Left Column: KPI Examples */}
          <div className="flex-1 flex flex-col gap-5">
            <div className="text-xl font-bold text-gray-600 mb-2 border-l-4 border-gray-300 pl-3">
              具体的な撤退ラインの例
            </div>
            ...
            {kpiExamples.map((kpi, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-white border border-gray-200 border-l-4 ${borderColor} rounded-xl p-5 flex items-center gap-5 shadow-sm hover:-translate-y-1 transition-transform duration-200`}
                >
          ...
          {/* Arrow indicator */}
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-gray-300 opacity-50 z-0">
            <ChevronRight className="w-8 h-8" />
          </div>

          {/* Right Column: Benefits */}
          <div className="flex-none w-[420px] bg-[#e1e1e1]/20 rounded-2xl p-6 border-2 border-dashed border-gray-300">
            <div className="text-xl font-bold text-[#FCCE00] mb-6 border-l-4 border-[#FCCE00] pl-3">
              撤退ラインを決めるメリット
            </div>
        ...
        {/* Footer Message */}
        <div className="mx-16 mb-10 bg-black rounded-2xl p-10 flex justify-between items-center relative overflow-hidden">
          {/* Background accent */}
