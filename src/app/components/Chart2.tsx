    ...
    <section className="h-screen w-screen bg-black flex flex-col overflow-hidden relative">
      ...
      {loading && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black z-50">
          ...
          {/* 下部に流れる黄色ライン */}
          <div className="absolute bottom-0 left-0 w-full h-[3px] bg-[#FCCE00]/25 overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center px-16 pb-12">
        <div className="relative w-full h-full max-w-5xl bg-white rounded-2xl shadow-xl">
          ...
          <iframe
            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRmsITImrRvgjWHzby1xJkBUurl2k-qj9shRaxJFilABiZm0IssaZJs5SiOL_IRa2AQVhgGz2Btthqo/pubchart?oid=333300526&format=interactive"
      ...
      <style>
        {`
          ...
          .animate-loadingBar {
            animation: loadingBar 1.4s infinite linear;
          }
        `}
      </style>
    </section>
